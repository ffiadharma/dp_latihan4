...
<div class="main-sidebar sidebar-style-2">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="<?php echo $this->uri->segment(2) == 'barang' ? 'active' : ''; ?>"><a class="nav-link" href="<?php echo base_url(); ?>dist/mahasiswa"><i class="far fa-square"></i> <span>Data Mahasiswa</span></a></li>
